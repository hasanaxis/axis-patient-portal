# Deploy Enhanced DICOM Receiver to Windows Server
...
# 3. Create the enhanced DICOM receiver content
Write-Host "`n3. Creating enhanced DICOM receiver..." -ForegroundColor Yellow

# Note: In a real deployment, you would copy the file from your development machine
# For this demo, we'll create a simplified version that can be typed manually
...
# 4. Write the enhanced DICOM receiver
